...
Assuming that you have [Node 10+](https://nodejs.org/en/download/) and [Git](https://git-scm.com/downloads) installed, you can use npm to install the Expo CLI command line utility:
